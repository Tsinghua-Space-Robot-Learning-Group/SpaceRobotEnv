...
if __name__ == '__main__':
    ...
    n_iter = 3
    figure_file = 'Learning_algorithm/Torch/PPOImage/plots/space_robot_performance.png'
    ...
    for i in range(n_iter):
        obs = env.reset()
        observation = obs["observation"].reshape(3, 64, 64)
        done = False
        score = 0
        while not done:
            ...
            observation = observation_["observation"].reshape(3, 64, 64)
        print("done")
