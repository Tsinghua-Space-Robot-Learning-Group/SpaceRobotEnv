...
# run tensor board tensorboard --logdir = /Users/emma/dev/SpaceRobotEnv/RL_algorithms/Torch/DDPG/DDPG_ENV/logger
#tensorboard --logdir=/Users/emma/dev/SpaceRobotEnv/RL_algorithms/Torch/DDPG/DDPG_ENV/logger
class ReplayBuffer:
    """
...
def ddpg(env_fn, actor_critic=core.MLPActorCritic, ac_kwargs=dict(), seed=0, 
    ...
    def test_agent():
        ...
        writer.add_scalar("Test_score avg", np.mean(avg_score_test), n_test_step)
...
if __name__ == '__main__':
    ...
    writer = SummaryWriter("RL_algorithms/Torch/DDPG/DDPG_ENV/logger")
    writer.add_text(
        "hyperparameters",
